...
3. Extract the zip and run the launcher:
   ...
   > **Note for Linux Users**: To enable the beautiful Blur/Glass effect, run the `setup_linux_blur_en.sh` script or read [LINUX_BLUR_GUIDE_EN.md](./doc/BlurEffectForLinux/LINUX_BLUR_GUIDE_EN.md).
